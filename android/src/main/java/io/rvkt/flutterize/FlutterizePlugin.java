...
/** FlutterizePlugin */
public class FlutterizePlugin implements FlutterPlugin, MethodCallHandler {
  ...
  public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
    ...
    channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "flutterize");
